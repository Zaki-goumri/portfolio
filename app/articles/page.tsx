...
import { ArrowLeft, FileText, PenTool, Clock, ExternalLink } from "lucide-react"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-green-400 neon-text">Technical Articles</h1>
          </div>
          <p className="text-green-300">Sharing knowledge about backend development and system architecture</p>
        </div>
        ...
        <Card className="mb-8 bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-blue-500/50">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-blue-400 text-xl">Technical Writing Journey</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <p className="text-green-300 leading-relaxed mb-4">
              As a backend software engineer with 2+ years of experience, I'm passionate about sharing knowledge and
              insights from my work with scalable systems, microservices, and high-performance APIs. I'm currently
              preparing a series of technical articles based on real-world projects and challenges.
            </p>
        ...
        {/* Upcoming Articles */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-green-400 mb-6">Upcoming Articles</h2>
          <div className="space-y-6">
            {upcomingArticles.map((article, index) => (
              ...
              >
                <CardHeader>
                  <CardTitle className="text-green-400 text-lg">{article.title}</CardTitle>
                ...
                <CardContent className="space-y-4">
                  <p className="text-green-300 leading-relaxed">{article.description}</p>
        ...
        <Card className="mb-8 bg-gray-900/50 border-green-500/30">
          <CardHeader>
            <CardTitle className="text-green-400 text-xl">Planned Writing Topics</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="mb-8 bg-gradient-to-r from-green-900/20 to-blue-900/20 border-green-500/50">
          <CardHeader>
            <CardTitle className="text-green-400 text-xl">Stay Updated</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="text-green-300">
              Want to be notified when I publish new technical articles? Connect with me on LinkedIn or follow my GitHub
              for updates on my latest writing and projects.
            </p>
        ...
        <Card className="mb-8 bg-gray-900/50 border-green-500/30">
          <CardHeader>
            <CardTitle className="text-green-400 text-xl">Writing Philosophy</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-green-300 leading-relaxed">
              My technical writing focuses on practical, real-world solutions backed by actual implementation
              experience. Each article will include code examples, performance metrics, and lessons learned from
              building production systems. I believe in sharing not just what works, but also what doesn't work and why,
              helping fellow developers avoid common pitfalls and make informed architectural decisions.
            </p>
          </CardContent>
        </Card>
